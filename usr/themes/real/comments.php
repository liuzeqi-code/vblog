    ...
    <div id="<?php $this->respondId(); ?>" class="respond">
    	...
    	<form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
    		...
    		<p>
    			...
    			<input type="email" name="mail" id="mail" class="text" placeholder="<?php _e('邮件'); ?>" value="<?php $this->remember('mail'); ?>"<?php if ($this->options->commentsRequireMail): ?> required<?php endif; ?> />
    		</p>
    		<p>
